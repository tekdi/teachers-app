...
export const getAssessmentQuestion = (): AssessmentQuestion[] => {
    return [
        ...
        {
            userId: 30,
            question: 'Q30. What is the area of a rectangle with length 8 and width 3?',
            score: 89,
        },
        {
            userId: 31,
        ...
        {
            userId: 43,
            question: 'Q43. What is the next number in the sequence: 1, 4, 9, 16, __?',
            score: 82,
        },
        {
            userId: 44,
        ...
        {
            userId: 47,
            question: 'Q47. What is the area of a triangle with base 10 and height 5?',
            score: 93,
        },
        {
            userId: 48,
